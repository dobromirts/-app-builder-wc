      ...
      <div class="column-layout group">
        <div class="column-layout group_1">
          ...
          <div class="row-layout group_6">
            <igc-grid .data="${this.northwindOrders}" primary-key="employeeID" display-density="cosy" allow-filtering="true" filter-mode="excelStyleFilter" auto-generate="false" class="ig-typography ig-scrollbar grid">
